        ...
        if custom_id == "Rules":
            ...
            channels_embed = discord.Embed(
                description=(
                    ...
                    "- 👨‍💻 **Leetcode challenges**\n"
                    f"  - **<#{constants.challenges_channel_id}>**: Introduce yourself to the community!\n"
                    f"  - **<#{constants.challenge_log_channel_id}>**: Find members to form a project team.\n"
                    f"  - **<#{constants.challenge_submission_channel_id}>**: Find members to form a project team.\n"
                    f"  - **<#{constants.challenge_discussion_channel_id}>**: Find members to form a project team.\n\n"
